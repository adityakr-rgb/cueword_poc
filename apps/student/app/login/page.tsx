...
export default function StudentLoginPage() {
  ...
  useEffect(() => {
    ...
    if (u && u.role === "student") router.replace("/");
  }, [router]);
  ...
  return (
    <div className="cw-login">
      <div className="cw-login-card">
        ...
        <h1>Log in</h1>
        <p className="cw-login-sub">Sign in to open your stories and join class.</p>
        ...
        <div className="cw-demo-accounts">
          ...
          <ul>
            <li>
              <b>{POC.student.username}</b> / {POC.student.password} — {POC.student.displayName}
            </li>
          </ul>
        </div>
      </div>
